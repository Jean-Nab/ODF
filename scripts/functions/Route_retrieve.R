...
extract_route = function(dsnTable, names_coord,buffer_small, buffer_medium, buffer_large, dsnRoute,
                         prefixe_fichier){
  ...
  # Jointure des tables d'extractions des differents buffers
    ...
    save(SpROUTE, file = paste0("C:/git/ODF/output/function_output/",prefixe_fichier,"ROUTE_envEPOC.RData")) # securite
    write.csv(SpROUTE, file = paste0("C:/git/ODF/output/function_output/",prefixe_fichier,"ROUTE_envEPOC.csv"), row.names = F)
